defmodule ISO6391.Codes do
  def list() do
    [
      ...
      %{iso_639_1: "ca", name: "Catalan"},
      %{iso_639_1: "ca", name: "Valencian"},
      %{iso_639_1: "km", name: "Central Khmer"},
      %{iso_639_1: "ch", name: "Chamorro"},
      %{iso_639_1: "ce", name: "Chechen"},
      %{iso_639_1: "ny", name: "Chichewa"},
      %{iso_639_1: "ny", name: "Chewa"},
      %{iso_639_1: "ny", name: "Nyanja"},
      %{iso_639_1: "zh", name: "Chinese"},
      %{iso_639_1: "cu", name: "Church Slavonic"},
      %{iso_639_1: "cu", name: "Old Bulgarian"},
      %{iso_639_1: "cu", name: "Old Church Slavonic"},
      ...
      %{iso_639_1: "dv", name: "Divehi"},
      %{iso_639_1: "dv", name: "Dhivehi"},
      %{iso_639_1: "dv", name: "Maldivian"},
      %{iso_639_1: "nl", name: "Dutch"},
      %{iso_639_1: "nl", name: "Flemish"},
      ...
      %{iso_639_1: "ki", name: "Gikuyu"},
      %{iso_639_1: "ki", name: "Kikuyu"},
      %{iso_639_1: "el", name: "Greek"},
      %{iso_639_1: "kl", name: "Greenlandic"},
      %{iso_639_1: "kl", name: "Kalaallisut"},
      %{iso_639_1: "gn", name: "Guarani"},
      %{iso_639_1: "gu", name: "Gujarati"},
      %{iso_639_1: "ht", name: "Haitian"},
      %{iso_639_1: "ht", name: "Haitian Creole"},
      ...
      %{iso_639_1: "lb", name: "Letzeburgesch"},
      %{iso_639_1: "lb", name: "Luxembourgish"},
      %{iso_639_1: "li", name: "Limburgish"},
      %{iso_639_1: "li", name: "Limburgan"},
      %{iso_639_1: "li", name: "Limburger"},
      ...
      %{iso_639_1: "ro", name: "Moldovan"},
      %{iso_639_1: "ro", name: "Moldavian"},
      %{iso_639_1: "ro", name: "Romanian"},
      %{iso_639_1: "mn", name: "Mongolian"},
      %{iso_639_1: "na", name: "Nauru"},
      %{iso_639_1: "nv", name: "Navajo"},
      %{iso_639_1: "nv", name: "Navaho"},
      ...
      %{iso_639_1: "ii", name: "Nuosu"},
      %{iso_639_1: "ii", name: "Sichuan Yi"},
      %{iso_639_1: "oc", name: "Occitan"},
      %{iso_639_1: "oj", name: "Ojibwa"},
      %{iso_639_1: "or", name: "Oriya"},
      %{iso_639_1: "om", name: "Oromo"},
      %{iso_639_1: "os", name: "Ossetian"},
      %{iso_639_1: "os", name: "Ossetic"},
      %{iso_639_1: "pi", name: "Pali"},
      %{iso_639_1: "pa", name: "Panjabi"},
      %{iso_639_1: "pa", name: "Punjabi"},
      %{iso_639_1: "ps", name: "Pashto"},
      %{iso_639_1: "ps", name: "Pushto"},
      ...
      %{iso_639_1: "za", name: "Chuang"},
      %{iso_639_1: "za", name: "Zhuang"},
